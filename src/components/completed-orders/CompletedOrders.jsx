...
import OrderInfoWrapper from "../../components/info/OrderInfoWrapper";
  ...
  return (
    <>
      {orderInfo === null ? (
            ...
            <tbody>
              {orders.map((order, index) => (
                <tr
                  ...
                  className={`border-b text-black hover:cursor-pointer hover:shadow-lg ${
        ...
        <OrderInfoWrapper setOrderInfo={setOrderInfo} orderInfo={orderInfo} />
      )}
    </>
  );
};
